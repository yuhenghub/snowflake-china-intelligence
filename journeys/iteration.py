        ...
        if item["type"] == "text":
            ...
            with st.container(height=500, border=False):
                ...
                if right.button(
                    ...
                    # Try to remove logical table CTE if present (Cortex Analyst format)
                    # If not present (Qwen-generated SQL), use the original SQL
                    try:
                        ...
                        # SQL doesn't have logical table CTE (e.g., Qwen-generated SQL)
                        sql_no_cte = sql
